...
get('/lootbox/show/:id')do
    ...
    creator=db.execute("SELECT username FROM Users WHERE id=?", result["creator_id"]).first["username"]
    ...
    slim(:'lootbox/show', locals:{images:imgSources, lootbox:result, creator:creator})
end
